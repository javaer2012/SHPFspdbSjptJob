package com.ideal.spdb.vehicle.model;
...
public class VehicleModel extends BaseModel {
	...
	@ExcelAnnotation(id=6,name="初始登记日期")
	private String firstRegDate; // 初始登记日期
	private String importdate; // 创建时间

	@ExcelAnnotation(id=10,name="触发查询时间")
	private String callDate; // 调用时间
	@ExcelAnnotation(id=11,name="返回查询时间")
