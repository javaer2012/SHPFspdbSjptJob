 ...
 * 
 * <p>Title:  浦发五星项目</p>
 * <p>Description:系统操作日志管理service接口</p>
 * <p>Company: 上海理想信息产业(集团)有限公司</p>
 * @author wls
 * create date: 2011-10-9
 * @version 1.0
 */
public interface ISysLogService extends BaseService<SysOperateLogModel>{
	/**
	 * 添加运行日志
   ...
   int getSysRunLogCount(PbLogSystemRunModel logSystemRunModel)throws Exception;
     ...
     */
   Pagenation querySysRunLog(String classMethod,PbLogSystemRunModel logSystemRunModel)throws Exception;
    ...
    * @throws Exception抛出所有异常
    */
  List<PbLogSystemRunModel> querySysRunLogAll(String classMethod,PbLogSystemRunModel logSystemRunModel)throws Exception;
