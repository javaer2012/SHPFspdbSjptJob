package com.ideal.spdb.juXinLiReport.to;

import com.ideal.spdb.utils.BaseModel;
import com.ideal.spdb.utils.ExcelAnnotation;

public class JxlReportModelTo extends BaseModel {

	private static final long serialVersionUID = -8673222383840605721L;
	...
	@ExcelAnnotation(id = 5, name = "查询结果")
	private String isEffective;
	@ExcelAnnotation(id = 6, name = "导入结果")
	private String flag;
	@ExcelAnnotation(id = 7, name = "查询类型")
	private String callType;

	private String isLocal;//是否本地库 0 否 1是
