 ...
 * @version 1.0
 */
public interface ISysPadService extends BaseService<SysPadModel>{
	/**
	 * 检测用户登录
	 * @param model实体
	 * @return 检测结果
	 */
	boolean checkLogin(SysPadModel model)throws Exception;
	/**
	 * 查询用户信息
	 * @param model实体
	 * @return 检测结果
     ...
     */
	boolean  addUser(SysPadModel model)throws Exception;
	 /**删除用户对应的角色
     * @param model model实体
     * @throws Exception抛出所有异常
     */
     ...
     * @throws Exception抛出所有异常
     */
    boolean  updateUser(SysPadModel model)throws Exception;
     ...
     * @throws Exception抛出所有异常
     */
    boolean updateOrgPrincipal(SysPadModel model)throws Exception;
}
