package com.ideal.spdb.idcheck.to;
 ...
 * @author uatyangxh
 */
public class IdCheckRecordModelTo extends BaseModel {
	private String idcheck_record_id;    //id
	private String applicationId;    //申请书编号
	private String identityCard;    //身份证号码
	private String idcheck_result;    //id check结果
	private String call_date;    //调用时间
	private String record_date;    //返回时间
	private String flag;    //导入结果（是否上传） ：1上传，0未上传
	private String isEffective;    //查询是否有效:0查询成功，1未查到数据，2查询失败，3未查询
	private String callType;    //处理类型：默认为0：线下，1.批量，2：手动导入 3.线上
	...
	public String getIdcheck_record_id() {
		return idcheck_record_id;
	}
	public void setIdcheck_record_id(String idcheck_record_id) {
		this.idcheck_record_id = idcheck_record_id;
	}
	...
	public String getIdcheck_result() {
		return idcheck_result;
	}
	public void setIdcheck_result(String idcheck_result) {
