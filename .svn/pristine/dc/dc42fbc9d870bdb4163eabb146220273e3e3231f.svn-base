 ...
 * </p>
 * <p>
 * Description:用户TO(Transfer Object)数据传输对象
 * </p>
 * <p>
 ...
 * @version 1.0
 */
public class SysUserTO extends BaseModel {
	...
	private String oldOrgId;// 原所属机构ID
	...
	public SysUserTO(String userName, String userPassword,
			String userRoleId, String parallelismRole, String roleName,
			String realName, String registerDate, String column7,
			String managerNo, String city, String state, String orgId,
			String oldOrgId, String orgName, String station, String post,
			String address, String tel, String email, String remark,
			String logoutTime, String backGround, String foreground,String branchapprovalcode) {
