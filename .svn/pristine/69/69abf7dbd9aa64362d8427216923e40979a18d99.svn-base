...
public class PbocResultModel extends PbocModel {
	...
	@ExcelAnnotation(id = 11, name = "授权员")
	...
	@ExcelAnnotation(id = 7, name = "操作员")
	private String operName;// 操作人
	private String errMsg;// 错误原因
	@ExcelAnnotation(id = 8, name = "导入时间")
	private String createTime;

	@ExcelAnnotation(id = 6, name = "查询结果")
	private String queryResult;// 查询结果
	
	@ExcelAnnotation(id = 9, name = "是否调库")
	private String is_local;//是否调用本地
	
	@ExcelAnnotation(id = 10, name = "操作人IP")
